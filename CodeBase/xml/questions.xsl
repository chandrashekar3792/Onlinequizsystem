...
<xsl:template match="/">
	<html>
		...
		<body>
			<form method="" action="">
				<xsl:apply-templates />
				<input type="button" name="ButtonNext" value="Next" onclick="NextQue()" />
				<input type="button" name="ButtonPrev" value="Previous" onclick="PrevQue()" />
			</form>
		</body>
	</html>
</xsl:template>
...
<xsl:template match="question">
	...
	<p>
		<label><xsl:value-of select="QText" />:</label><br />
