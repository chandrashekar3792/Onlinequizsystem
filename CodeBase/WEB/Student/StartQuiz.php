	...
	<fieldset>
		<table class="table1" style="float:left" border="1px">
			...
			<table border="1px"-->
				<tr>
					<td rowspan="2">
					<br /><br /><br /><br /><br /><br /><iframe src="QuestionDisplaypage.php" width="500px" height="400px" frameborder="0" ></iframe>
					</td>
				...
				<tr> 
					<!--td>2rc1</td-->
					<td><pre>    </pre><iframe src="./grid.php" width="165px" height="180px" frameborder="0"></iframe><br /> Questions Grid</td>
				</tr>
			<!--/table>
			</td>
			<tr>
